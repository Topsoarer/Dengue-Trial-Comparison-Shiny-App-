...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(id = "tabs",
                ...
                menuItem("Github", icon = icon("github"), href = "https://github.com/Topsoarer"),
                # IMPORTANT: This link requires a 'www' folder in your app directory
                # containing the 'model_description.html' file.
                ...
                # This now correctly links to the "author" tabItem below
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      # NEW: Author information tab content
...
server <- function(input, output, session) {
  ...
  # -- b) Observer for the "Add Record" button click --
  ...
  # -- e) Reactive expression to compute derived parameters from inputs --
  params <- reactive({
